...
class ReportBackModel: NSObject {
    ...
    fileprivate func configureContentview() {
        contentView.frame = CGRect(x: 40, y: UIScreen.main.bounds.size.height, width: UIScreen.main.bounds.size.width-80, height: contentView.frame.size.height+1)
