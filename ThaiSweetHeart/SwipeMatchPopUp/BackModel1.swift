...
class BackModel1: NSObject {
    ...
    fileprivate func configureContentview() {
        contentView.frame = CGRect(x: 90, y: UIScreen.main.bounds.size.height, width: UIScreen.main.bounds.size.width-180, height: contentView.frame.size.height+10)
